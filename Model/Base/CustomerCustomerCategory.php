...
use CustomerCategory\Model\Thelia\Model\Customer as ChildCustomer;
use CustomerCategory\Model\Thelia\Model\CustomerQuery;
...
abstract class CustomerCustomerCategory implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CustomerCategory\\Model\\Map\\CustomerCustomerCategoryTableMap';
    ...
    /**
     * Initializes internal state of CustomerCategory\Model\Base\CustomerCustomerCategory object.
     */
    ...
    /**
     * Compares this with another <code>CustomerCustomerCategory</code> instance.  If
     * <code>obj</code> is an instance of <code>CustomerCustomerCategory</code>, delegates to
     * <code>equals(CustomerCustomerCategory)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return CustomerCustomerCategory The current object, for fluid interface
     */
    ...
    public function setCustomerId($v)
    {
        ...
        if ($this->customer_id !== $v) {
            $this->customer_id = $v;
            $this->modifiedColumns[CustomerCustomerCategoryTableMap::CUSTOMER_ID] = true;
        }
    ...
    public function setCustomerCategoryId($v)
    {
        ...
        if ($this->customer_category_id !== $v) {
            ...
            $this->modifiedColumns[CustomerCustomerCategoryTableMap::CUSTOMER_CATEGORY_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CustomerCustomerCategoryTableMap::translateFieldName('CustomerId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCustomerCustomerCategoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CustomerCustomerCategory::setDeleted()
     * @see CustomerCustomerCategory::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildCustomerCustomerCategoryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CustomerCustomerCategoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CustomerCustomerCategoryTableMap::CUSTOMER_ID)) {
    ...
    {
        $pos = CustomerCustomerCategoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CustomerCustomerCategory'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CustomerCustomerCategory'][$this->getPrimaryKey()] = true;
        $keys = CustomerCustomerCategoryTableMap::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(CustomerCustomerCategoryTableMap::DATABASE_NAME);
        $criteria->add(CustomerCustomerCategoryTableMap::CUSTOMER_ID, $this->customer_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CustomerCategory\Model\CustomerCustomerCategory (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \CustomerCategory\Model\CustomerCustomerCategory Clone of current object.
     * @throws PropelException
     */
    ...
    public function setCustomer(ChildCustomer $v = null)
    {
        ...
        if ($v !== null) {
            $v->setCustomerCustomerCategory($this);
        }
    ...
    public function getCustomer(ConnectionInterface $con = null)
    {
        if ($this->aCustomer === null && ($this->customer_id !== null)) {
            ...
            $this->aCustomer->setCustomerCustomerCategory($this);
        }
    ...
    {
        return (string) $this->exportTo(CustomerCustomerCategoryTableMap::DEFAULT_STRING_FORMAT);
    }
