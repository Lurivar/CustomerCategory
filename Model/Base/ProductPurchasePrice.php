...
use CustomerCategory\Model\Thelia\Model\Currency as ChildCurrency;
use CustomerCategory\Model\Thelia\Model\ProductSaleElements as ChildProductSaleElements;
use CustomerCategory\Model\Thelia\Model\CurrencyQuery;
use CustomerCategory\Model\Thelia\Model\ProductSaleElementsQuery;
...
abstract class ProductPurchasePrice implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\CustomerCategory\\Model\\Map\\ProductPurchasePriceTableMap';
    ...
    /**
     * Initializes internal state of CustomerCategory\Model\Base\ProductPurchasePrice object.
     * @see applyDefaults()
     */
     ...
     * @return   \CustomerCategory\Model\ProductPurchasePrice The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \CustomerCategory\Model\ProductPurchasePrice object", 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CustomerCategory\Model\ProductPurchasePrice (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \CustomerCategory\Model\ProductPurchasePrice Clone of current object.
     * @throws PropelException
     */
