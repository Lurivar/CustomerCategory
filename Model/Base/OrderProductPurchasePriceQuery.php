...
use \Exception;
use \PDO;
use CustomerCategory\Model\OrderProductPurchasePrice as ChildOrderProductPurchasePrice;
use CustomerCategory\Model\OrderProductPurchasePriceQuery as ChildOrderProductPurchasePriceQuery;
use CustomerCategory\Model\Map\OrderProductPurchasePriceTableMap;
use CustomerCategory\Model\Thelia\Model\OrderProduct;
...
abstract class OrderProductPurchasePriceQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \CustomerCategory\Model\Base\OrderProductPurchasePriceQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'thelia', $modelName = '\\CustomerCategory\\Model\\OrderProductPurchasePrice', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \CustomerCategory\Model\OrderProductPurchasePriceQuery) {
            return $criteria;
        }
        $query = new \CustomerCategory\Model\OrderProductPurchasePriceQuery();
        if (null !== $modelAlias) {
    ...
    /**
     * Filter the query by a related \CustomerCategory\Model\Thelia\Model\OrderProduct object
     *
     * @param \CustomerCategory\Model\Thelia\Model\OrderProduct|ObjectCollection $orderProduct The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildOrderProductPurchasePriceQuery The current query, for fluid interface
     */
    ...
    {
        if ($orderProduct instanceof \CustomerCategory\Model\Thelia\Model\OrderProduct) {
            return $this
            ...
            throw new PropelException('filterByOrderProduct() only accepts arguments of type \CustomerCategory\Model\Thelia\Model\OrderProduct or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \CustomerCategory\Model\Thelia\Model\OrderProductQuery A secondary query class using the current class as primary query
     */
    public function useOrderProductQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'OrderProduct', '\CustomerCategory\Model\Thelia\Model\OrderProductQuery');
    }
