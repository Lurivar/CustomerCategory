...
use \Exception;
use \PDO;
use CustomerCategory\Model\ProductPurchasePrice as ChildProductPurchasePrice;
use CustomerCategory\Model\ProductPurchasePriceQuery as ChildProductPurchasePriceQuery;
use CustomerCategory\Model\Map\ProductPurchasePriceTableMap;
use CustomerCategory\Model\Thelia\Model\Currency;
use CustomerCategory\Model\Thelia\Model\ProductSaleElements;
...
abstract class ProductPurchasePriceQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \CustomerCategory\Model\Base\ProductPurchasePriceQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'thelia', $modelName = '\\CustomerCategory\\Model\\ProductPurchasePrice', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \CustomerCategory\Model\ProductPurchasePriceQuery) {
            return $criteria;
        }
        $query = new \CustomerCategory\Model\ProductPurchasePriceQuery();
        if (null !== $modelAlias) {
    ...
    /**
     * Filter the query by a related \CustomerCategory\Model\Thelia\Model\ProductSaleElements object
     *
     * @param \CustomerCategory\Model\Thelia\Model\ProductSaleElements|ObjectCollection $productSaleElements The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildProductPurchasePriceQuery The current query, for fluid interface
     */
    ...
    {
        if ($productSaleElements instanceof \CustomerCategory\Model\Thelia\Model\ProductSaleElements) {
            return $this
            ...
            throw new PropelException('filterByProductSaleElements() only accepts arguments of type \CustomerCategory\Model\Thelia\Model\ProductSaleElements or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \CustomerCategory\Model\Thelia\Model\ProductSaleElementsQuery A secondary query class using the current class as primary query
     */
    public function useProductSaleElementsQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'ProductSaleElements', '\CustomerCategory\Model\Thelia\Model\ProductSaleElementsQuery');
    }

    /**
     * Filter the query by a related \CustomerCategory\Model\Thelia\Model\Currency object
     *
     * @param \CustomerCategory\Model\Thelia\Model\Currency|ObjectCollection $currency The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildProductPurchasePriceQuery The current query, for fluid interface
     */
    ...
    {
        if ($currency instanceof \CustomerCategory\Model\Thelia\Model\Currency) {
            return $this
            ...
            throw new PropelException('filterByCurrency() only accepts arguments of type \CustomerCategory\Model\Thelia\Model\Currency or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \CustomerCategory\Model\Thelia\Model\CurrencyQuery A secondary query class using the current class as primary query
     */
    public function useCurrencyQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCurrency($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Currency', '\CustomerCategory\Model\Thelia\Model\CurrencyQuery');
    }
