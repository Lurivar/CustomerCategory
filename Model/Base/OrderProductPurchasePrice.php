...
use CustomerCategory\Model\Thelia\Model\OrderProduct as ChildOrderProduct;
use CustomerCategory\Model\Thelia\Model\OrderProductQuery;
...
abstract class OrderProductPurchasePrice implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\CustomerCategory\\Model\\Map\\OrderProductPurchasePriceTableMap';
    ...
    /**
     * Initializes internal state of CustomerCategory\Model\Base\OrderProductPurchasePrice object.
     * @see applyDefaults()
     */
     ...
     * @return   \CustomerCategory\Model\OrderProductPurchasePrice The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \CustomerCategory\Model\OrderProductPurchasePrice object", 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CustomerCategory\Model\OrderProductPurchasePrice (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \CustomerCategory\Model\OrderProductPurchasePrice Clone of current object.
     * @throws PropelException
     */
