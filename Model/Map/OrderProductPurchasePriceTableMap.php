...
use CustomerCategory\Model\OrderProductPurchasePriceQuery;
...
class OrderProductPurchasePriceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'CustomerCategory.Model.Map.OrderProductPurchasePriceTableMap';
     ...
     */
    const OM_CLASS = '\\CustomerCategory\\Model\\OrderProductPurchasePrice';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CustomerCategory.Model.OrderProductPurchasePrice';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CustomerCategory\\Model\\OrderProductPurchasePrice');
    ...
    {
        $this->addRelation('OrderProduct', '\\CustomerCategory\\Model\\Thelia\\Model\\OrderProduct', RelationMap::MANY_TO_ONE, array('order_product_id' => 'id', ), 'CASCADE', 'RESTRICT');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CustomerCategory\Model\OrderProductPurchasePrice) { // it's a model object
