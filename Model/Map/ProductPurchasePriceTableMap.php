...
use CustomerCategory\Model\ProductPurchasePrice;
...
class ProductPurchasePriceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'CustomerCategory.Model.Map.ProductPurchasePriceTableMap';
     ...
     */
    const OM_CLASS = '\\CustomerCategory\\Model\\ProductPurchasePrice';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CustomerCategory.Model.ProductPurchasePrice';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CustomerCategory\\Model\\ProductPurchasePrice');
    ...
    {
        $this->addRelation('ProductSaleElements', '\\CustomerCategory\\Model\\Thelia\\Model\\ProductSaleElements', RelationMap::MANY_TO_ONE, array('product_sale_elements_id' => 'id', ), 'CASCADE', 'RESTRICT');
        $this->addRelation('Currency', '\\CustomerCategory\\Model\\Thelia\\Model\\Currency', RelationMap::MANY_TO_ONE, array('currency_id' => 'id', ), 'CASCADE', 'RESTRICT');
    } // buildRelations()
     ...
     * and findPk*() calls.
     *
     * @param \CustomerCategory\Model\ProductPurchasePrice $obj A \CustomerCategory\Model\ProductPurchasePrice object.
     ...
     *
     * @param mixed $value A \CustomerCategory\Model\ProductPurchasePrice object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \CustomerCategory\Model\ProductPurchasePrice) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \CustomerCategory\Model\ProductPurchasePrice object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CustomerCategory\Model\ProductPurchasePrice) { // it's a model object
